      ...
      <footer class="site-footer">
         <div class="col-xl-6">
          <div class="text-center ">
              <?php echo date('Y');?> - Fuadz Production
                <li class="nav-item">
                <a href="https://api.whatsapp.com/send/?phone=08817572506" class="nav-link" target="_blank">WhatsApp</a>
              </li>
                <li class="nav-item">
                <a href="https://www.instagram.com/fuadz_amin" class="nav-link" target="_blank">Instagram</a>
              </li>
              <li class="nav-item">
                <a href="https://web.facebook.com/misbahuel.fuadz?refid=7" class="nav-link" target="_blank">Facebook</a>
              </li>
              <a href="#" class="go-top">
